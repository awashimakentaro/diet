 ...
 *
 * 【他ファイルとの関係】
 * - settings/api 配下の取得保存処理と settings/utils/calculate-goal-from-profile を利用する。
 */
...
import { calculateGoalFromProfile } from '../settings/utils/calculate-goal-from-profile';
