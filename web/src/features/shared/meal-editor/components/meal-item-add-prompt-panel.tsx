...
import { MealPhotoInputTools } from './meal-photo-input-tools';
import { MealPromptAttachmentStrip } from './meal-prompt-attachment-strip';

type MealItemAddPromptPanelProps = {
...
export function MealItemAddPromptPanel({
  promptRegistration,
  isAnalyzing,
  onApplyPrompt,
  onBack,
  ...
  attachments,
  onRemoveAttachment,
}: MealItemAddPromptPanelProps): JSX.Element {
  return (
